-- Seed existing blog posts from content collection into D1 (remote version)
-- Uses NULL author_id since admin user is auto-seeded on first login

-- Clean up partial test insert if any
DELETE FROM blog_posts WHERE slug = 'getting-started-with-astro' AND content = '# Getting Started with Astro

Astro is a modern framework for building fast, optimized websites.';
